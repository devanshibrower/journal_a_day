  ...
  return (
    <div className="flex flex-col justify-between bg-zinc-100 rounded-lg py-1.5 px-1 h-full">
      ...
      <button
        ...
        className="p-1 rounded-md transition-all group hover:scale-[1.2]"
        title="Clear canvas"
      >
        <svg width="16" height="16" viewBox="0 0 6 6" fill="none" xmlns="http://www.w3.org/2000/svg" className="transition-colors">
