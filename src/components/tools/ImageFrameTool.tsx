...
export const FRAME_PATTERNS: FramePattern[] = [
      ...
      <svg width="53" height="53" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clipPath="url(#clip0_regular)">
          ...
          {isSelected ? (
            ...
            <>
              <path d="M1 10.4999C2.19786 9.76782 4 7.49989 6 11.4999C6.91756 13.335 7.75021 7.43738 10 7.99992C12 8.5 14.1765 11.1628 15 11.9999" stroke={isHovered ? '#18181B' : '#A1A1AA'} strokeWidth="0.875" strokeLinecap="round"/>
              <circle cx="12.3125" cy="4.3125" r="1.3125" fill={isHovered ? '#18181B' : '#A1A1AA'}/>
            </>
          )}
        </g>
        <defs>
      ...
      <svg width="53" height="53" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g clipPath="url(#clip0_139_617)">
          ...
          {isSelected ? (
            ...
            <>
              <path d="M1.8457 9.51938C2.81321 8.9281 4.26878 7.09631 5.88416 10.3271C6.62527 11.8093 7.29779 7.04582 9.11493 7.50018C10.7303 7.90409 12.4882 10.0548 13.1534 10.7309" stroke={isHovered ? '#18181B' : '#A1A1AA'} strokeWidth="0.706731" strokeLinecap="round"/>
              <circle cx="10.9839" cy="4.52128" r="1.0601" fill={isHovered ? '#18181B' : '#A1A1AA'}/>
            </>
          )}
        </g>
        <defs>
  ...
  },
  {
    ...
    svg: (color: string, isSelected: boolean, isHovered: boolean = false) => (
      <svg width="53" height="53" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect x="1.74219" y="0.699951" width="11.7" height="13.6" rx="0.2" fill={isSelected ? color : isHovered ? '#18181B' : '#A1A1AA'}/>
        <g clipPath="url(#clip0_139_641)">
          ...
          {isSelected ? (
            ...
            <>
              <path d="M2.3418 8.46713C3.24546 7.91486 4.60499 6.20394 6.11379 9.22153C6.80599 10.6059 7.43414 6.15678 9.13139 6.58116C10.6402 6.95842 12.2821 8.96722 12.9034 9.59873" stroke={isHovered ? '#18181B' : '#A1A1AA'} strokeWidth="0.660099" strokeLinecap="round"/>
              <circle cx="10.8769" cy="3.7985" r="0.990148" fill={isHovered ? '#18181B' : '#A1A1AA'}/>
            </>
          )}
        </g>
      </svg>
...
export const FramePatternPreview: React.FC<{ pattern: FramePattern; isSelected: boolean; onClick: () => void }> = ({
  ...
  return (
    <div className="relative" style={{ width: '24px', height: '24px' }}>
      ...
      >
        {pattern.previewSvg(isSelected ? '#18181B' : '#A1A1AA')}
      </button>
    </div>
  );
};
