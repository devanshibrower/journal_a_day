      ...
      <svg width="53" height="53" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <clipPath id="rounded-corners">
            <rect x="1" y="1" width="14" height="14" rx="0.875" />
          </clipPath>
        </defs>
        {isSelected ? (
          // Simple direct image for selected state with rounded corners
          <image 
            href={frameImageUrl} 
            x="1" 
            y="1" 
          ...
          // Original landscape SVG for unselected state
          <>
            <rect x="1" y="1" width="14" height="14" rx="0.875" fill="#E5E5E5"/>
    ...
    svg: (color: string, isSelected: boolean, isHovered: boolean = false) => (
      <svg width="53" height="53" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g clipPath="url(#clip0_139_641)">
          {isSelected ? (
            <>
              <rect x="2.3418" y="1.30005" width="10.5" height="10.5" rx="0.1" fill="#E5E5E5"/>
              <image 
                href={frameImageUrl} 
                x="2.3418" 
                y="1.30005" 
        ...
        <defs>
          <clipPath id="clip0_139_641">
            <rect x="2.3418" y="1.30005" width="10.5" height="10.5" rx="0.1" fill="white"/>
          </clipPath>
        </defs>
      </svg>
    ),
      ...
      <svg width="28" height="28" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g clipPath="url(#clip0_83_252)">
          ...
          <g clipPath="url(#clip1_83_252)">
            <rect x="3.33398" y="2.58325" width="5.33333" height="5.33333" rx="0.0777778" fill="#E5E5E5"/>
            <path d="M3.33398 6.08325C3.77398 5.79992 4.53398 4.91659 5.33398 6.58325C5.63398 7.24992 5.94065 4.99992 6.91732 5.24992C7.75065 5.47492 8.54232 6.41659 8.86732 6.74992" stroke={color} strokeWidth="0.341667" strokeLinecap="round"/>
            <circle cx="7.83398" cy="3.41699" r="0.5" fill={color}/>
          </g>
        </g>
        <defs>
      ...
      <svg width="53" height="53" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <defs>
          <clipPath id="clip0_139_617">
            <rect x="2" y="2" width="11" height="11" rx="0.706731" fill="white"/>
          </clipPath>
        </defs>
      </svg>
    ),
